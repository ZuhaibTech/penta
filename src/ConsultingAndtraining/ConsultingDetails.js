...
export default function ConsultingDetails() {
  const services = [
    { title: "Business Strategy Consulting", desc: "Drive growth and innovation with our business strategy consulting services tailored for the digital age." },
    { title: "Change Management Solutions", desc: "Facilitate successful organizational transitions with our comprehensive change management solutions." },
    { title: "Customized Training Programs", desc: "Boost workforce capabilities and internal talent with our specialized, high-impact training programs." },
    { title: "Workshops & Seminars", desc: "Engage and inspire your team with our interactive workshops designed to spark creative problem-solving." },
    { title: "Leadership Development", desc: "Cultivate effective, visionary leaders with our executive coaching and leadership development programs." },
    { title: "Performance Improvement Strategies", desc: "Achieve operational excellence and maximize ROI with data-driven performance insights." }
  ];
    ...
    <section className="py-12 md:py-24 px-4 md:px-6 bg-[#f8fafc] text-slate-900 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 md:gap-16 items-center">
        ...
        <div className="w-full lg:w-2/5 text-center lg:text-left">
          ...
          {/* CTA AREA: Glassy Animated Icon + Centered Alignment */}
          <div className="flex flex-col items-center lg:items-center lg:pl-24 gap-10">
            <div className="relative group">
              ...
              <div className="relative w-28 h-28 md:w-32 md:h-32 bg-gradient-to-br from-white to-blue-50/50 rounded-3xl shadow-[0_20px_50px_rgba(2,132,199,0.15)] flex items-center justify-center border border-white overflow-hidden">
                ...
                <Handshake className="w-12 h-12 md:w-16 md:h-16 text-[#0284c7] drop-shadow-md animate-[pulse_4s_ease-in-out_infinite]" />
              </div>
            </div>
