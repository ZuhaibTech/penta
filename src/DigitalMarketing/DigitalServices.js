...
export default function WhyChooseUs() {
  const points = [
    { title: "Certified Expertise", desc: "Our team consists of certified Salesforce & Cloud experts dedicated to your success." },
    { title: "End-to-End Consulting", desc: "We guide you through the entire journey from strategy and execution to ongoing support." },
    { title: "Industry-focused Solutions", desc: "We don't believe in one-size-fits-all; we build solutions tailored to your specific sector." },
    { title: "Agile Delivery Process", desc: "Experience a transparent and rapid delivery process that keeps you in the loop at every stage." },
    { title: "Human-First Innovation", desc: "We combine high-tech AI innovation with a grounded, human-first approach to problem solving." }
  ];

  return (
    <section className="py-12 md:py-24 px-4 md:px-6 bg-[#f8fafc] text-slate-900 overflow-hidden relative">
      {/* Ambient Glass Background Decorative Orbs - EXACT MATCH */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-100/50 rounded-full blur-[120px] -z-10 animate-pulse" />
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 md:gap-16 items-center">
        ...
        <div className="w-full lg:w-2/5 text-center lg:text-left">
          ...
          <p className="text-sm md:text-lg text-slate-600 leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
            We don't just deliver technology; we deliver sustainable business growth through expert-led digital transformation.
          </p>

          {/* CTA AREA: Exact Glassy Animated Icon + Centered CTA */}
          <div className="flex flex-col items-center lg:items-center lg:pl-24 gap-10">
            <div className="relative group">
              ...
              <div className="relative w-28 h-28 md:w-32 md:h-32 bg-gradient-to-br from-white to-blue-50/50 rounded-3xl shadow-[0_20px_50px_rgba(2,132,199,0.15)] flex items-center justify-center border border-white overflow-hidden">
                ...
                <ShieldCheck className="w-12 h-12 md:w-16 md:h-16 text-[#0284c7] drop-shadow-md animate-[pulse_4s_ease-in-out_infinite]" />
              </div>
            </div>
        ...
        {/* Right Side: Service List with Glass Hover Effects */}
