...
export default function WhyChooseUs() {
  ...
  return (
    <section className="py-12 md:py-24 px-4 md:px-6 bg-[#f8fafc] text-slate-900 overflow-hidden relative">
      {/* Ambient Glass Background Decorative Orbs - Matching MigrationServices */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 md:gap-20 items-center">
        ...
        <div className="w-full lg:w-2/5 text-center lg:text-left">
          ...
          {/* CTA AREA: Layered Glass Icon + Vertical CTA - Matching exact layout */}
          <div className="flex flex-col items-center lg:items-center lg:pl-24 gap-10">
            <div className="relative group">
              ...
              <div className="relative w-28 h-28 md:w-32 md:h-32 bg-gradient-to-br from-white to-blue-50/50 rounded-3xl shadow-[0_20px_50px_rgba(2,132,199,0.15)] flex items-center justify-center border border-white overflow-hidden">
                ...
                <ShieldCheck className="w-12 h-12 md:w-16 md:h-16 text-[#0284c7] drop-shadow-md animate-[bounce_4s_ease-in-out_infinite]" />
              </div>
            </div>
        ...
        {/* Right Side: Points List with Glass Hover Interaction */}
        <div className="w-full lg:w-3/5 grid grid-cols-1 gap-4 md:gap-5">
          {points.map((pt, i) => (
            <div 
              key={i} 
            ...
            >
              ...
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-white shadow-sm flex-shrink-0 flex items-center justify-center border border-slate-100 group-hover:scale-110 group-hover:bg-[#0284c7] group-hover:text-white transition-all duration-500 group-hover:rotate-12">
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5 transition-transform group-hover:-rotate-45" />
              </div>
              
              <div className="text-left flex items-center">
                <h3 className="text-sm md:text-xl font-black text-slate-800 group-hover:text-[#0284c7] transition-colors leading-tight">
                  {pt}
                </h3>
              </div>
            </div>
